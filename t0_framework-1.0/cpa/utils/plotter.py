# PyAlgoTrade
#
# Change line 105-108, in order to skip the gaps in plotting datetime Series change author xuefu <sdu.xuefu@gmail.com>
...
class Series(object):
    ...
    def plot(self, mplSubplot, dateTimes, color):
        ...
        mplSubplot.plot(range(len(dateTimes)), values, color=color, marker=self.getMarker())
